...
namespace TheyAreComing {
    public class HowToPlay {
        ...
        private const float ContentHeight = 1460f;
        ...
        public void Draw() {
            ...
            string cred = lang == 0
                ? "Made by: Pusztai Attila  &  Claude AI"
                : "Keszitette: Pusztai Attila  &  Claude AI";
            Raylib.DrawText(cred,
                W / 2 - Raylib.MeasureText(cred, 13) / 2,
                H - 20, 13,
                new Color(180, 140, 60, 220));
        ...
        private void DrawEnglish(ref int y) {
            ...
            BulletRow("HEADSHOT = ~2.4x damage. Aim at the top of the zombie sprite.", ref y);
            ...
            WeaponRow("Shotgun", "$200", " 8 ammo  |  dmg 20   |  5 pellets/shot  |  reload 2.5s", ref y);
            WeaponRow("M4 Rifle", "$350", "30 ammo  |  dmg 40   |  cooldown 0.18s  |  reload 2.2s", ref y);
            WeaponRow("Sniper", "$500", " 5 ammo  |  dmg 130  |  cooldown 1.20s  |  reload 3.0s", ref y);
            y += 6;
            ...
            BulletRow("Barricade charges are bought in the Upgrade Shop ($100 each, max 3x).", ref y);

            SectionTitle("UPGRADES (every 3rd wave)", ref y);
            BulletRow("Pick 1 of 3 random upgrades each time.", ref y);
            BulletRow("Examples: max HP boost, lifesteal on hit,", ref y);
            BulletRow("faster reload, damage multiplier, move speed.", ref y);
            BulletRow("Shop also sells: First Aid Kit (full HP, $100) and Barricades ($100 each).", ref y);
            ...
            BulletRow("Save money early to reach M4 or Sniper by wave 3.", ref y);
        ...
        private void DrawMagyar(ref int y) {
            ...
            BulletRow("FEJLÖVÉS = ~2.4x sebzés. Célozz a zombi sprite tetejére.", ref y);
            ...
            WeaponRow("Shotgun", "$200", " 8 löv  |  20 seb   |  5 pellet  |  2.5s tölt", ref y);
            WeaponRow("M4 Rifle", "$350", "30 löv  |  40 seb   |  0.18s CD  |  2.2s tölt", ref y);
            WeaponRow("Sniper", "$500", " 5 löv  | 130 seb   |  1.20s CD  |  3.0s tölt", ref y);
            y += 6;
            ...
            BulletRow("Barrikád töltetek a Fejlesztés Shopban vehetők ($100/db, max 3x).", ref y);

            SectionTitle("FEJLESZTÉSEK (minden 3. körben)", ref y);
            BulletRow("Minden alkalommal 1-et választasz 3 véletlenszerű közül.", ref y);
            BulletRow("Példák: max HP növelés, életlopás találatnál,", ref y);
            BulletRow("gyorsabb töltés, sebzés szorzó, mozgássebesség.", ref y);
            BulletRow("Shop: Elsősegélycsomag (teljes HP, $100) és Barrikád ($100/db).", ref y);
            ...
            BulletRow("Spórolj a 3. körig M4-re vagy Sniperre.", ref y);
